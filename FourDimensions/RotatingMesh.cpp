...
{ }
RotatingMesh::RotatingMesh(Mesh mesh, const sf::Clock & clock, Vector4 vectorRotation1, Vector4 vectorRotation2, FPN rotationSpeedAround, FPN rotationSpeedInside) :
	Mesh(mesh), initialRotation(mesh.getRotation()), vectorRotation1(vectorRotation1), vectorRotation2(vectorRotation2), rotationSpeedAround(rotationSpeedAround), rotationSpeedInside(rotationSpeedInside), clock(clock)
{ }
